...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    [TMTaskStore sharedStore].psc = self.persistentStoreCoordinator;
...
- (void)applicationWillResignActive:(UIApplication *)application
{
    ...
    [self saveContext];
    [[TMTaskStore sharedStore] saveCurrentRunningTask];
}
...
- (void)applicationDidBecomeActive:(UIApplication *)application
{
    ...
    [[TMTaskStore sharedStore] loadCurrentRunningTask];
}
...
- (NSManagedObjectModel *)managedObjectModel
{
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"TimingMate" withExtension:@"momd"];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator
{
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"TimingMate.sqlite"];
